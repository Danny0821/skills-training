---
name: "python-visuals-agent"
description: "Specialized agent managing python-visuals capabilities."
...
# AGENT.md — python-visuals-agent Profile

## Persona
- **Role**: Specialized python-visuals specialist agent.
