...
description: "Specialized agent managing python-fixer capabilities."
...
# AGENT.md — python-fixer-agent Profile

<instructions>
  <role>
  - Specialized python-fixer specialist agent.
  ...
  <task_definition>
  - Execute allowed skills: python-fixer
