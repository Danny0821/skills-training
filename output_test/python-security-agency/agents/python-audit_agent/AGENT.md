---
name: "python-audit-agent"
description: "Specialized agent managing python-audit capabilities."
...
# AGENT.md — python-audit-agent Profile

<instructions>
  <role>
  - Specialized python-audit specialist agent.
  ...
  <task_definition>
  - Execute allowed skills: python-audit
